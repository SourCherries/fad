...
# import sys
import numpy as np
# import ..align.procrustes_tools as pt
import fad.align.procrustes_tools as pt
...
def get_geomorph_plethodon_data():
    in_shapes_file = files('fad.align.tests.R').joinpath('input_shapes.csv')
    al_shapes_file = files('fad.align.tests.R').joinpath('align_shapes.csv')
    al_ref_file = files('fad.align.tests.R').joinpath('align_reference.csv')
